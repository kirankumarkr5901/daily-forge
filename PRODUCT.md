...
**Invariants that constrain every future change** (full detail in `docs/DAILYFORGE_SPEC.md` §4–§5, summarised in `CLAUDE.md`):
...
- `CLAUDE.md` — the short operating manual, supplied by the owner.
