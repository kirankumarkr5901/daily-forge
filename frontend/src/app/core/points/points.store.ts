...
/**
 * The one shared source of truth for "what is the user's score right now" (see CLAUDE.md's
 ...
 *
 * The frontend never calculates points (CLAUDE.md invariant 4): `applyEnvelope` only ever
